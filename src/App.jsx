...
function App() {
  ...
  const WebTech = [
    ...
    { icon: IoLogoJavascript, label: 'JavaScript', color: 'yellow-500'},
    { icon: RiTailwindCssFill, label: 'Tailwind', color: 'blue-500' },
    { icon: FaReact, label: 'React', color: 'blue-500' },
    { icon: FaNode, label: 'Node', color: 'green-500' },
    { icon: SiExpress, label: 'Express', color: 'white'},
    { icon: SiMongodb, label: 'MongoDB', color: 'green-500' },
    { icon: SiMysql, label: 'MySQL', color: 'blue-500'} 
  ];
  ...
  return (
    ...
    <div className=" md:h-[100vh] h-[90vh] flex text-center items-center justify-center h-[72vh] sm:pt-[10vh] md:pt-[0] pt-[20vh]">
      <div className="md:text-4xl text-3xl font-medium flex flex-col items-center text-white">
        <p>Hello! I'm </p>
    ...
    <div id="aboutMe" className="text-white h-[100vh] flex flex-col justify-center items-center gap-12">
    ...
    <div className="text-white h-[100vh] pt-[80px] flex justify-start items-center flex-col">
        ...
        <h2 className="h2s text-center my-[25px]">Web Development Technologies</h2>
          <ul className="web-dev-skills flex grid grid-cols-3 px-[25px] gap-3 items-center justify-between  h-[10%]">
            {WebTech.map((skill, index) => (
              <SkillCard key={index} icon={skill.icon} label={skill.label} color={skill.color}/>
            ))}
          </ul>
    </div>
    </>
